...
<body>
	...
	<div id="global" class="container">
		<div class="row">
			...
			<form action="/examJeeFayolleAlexandre3/UpdateUser" method="post">
				<div class="form-group">
					...
					<div class="input-group mb-2">
						...
						<input type="email" class="form-control" id="exampleInputEmail1"
							placeholder="<%= request.getParameter("login") %>" name="login">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="input-group mb-2">
						...
						<input type="password" class="form-control"
							id="exampleInputPassword1" placeholder="Pour votre sécurité veuillez entrer le mot de passe a nouveau"name="password">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="input-group mb-2">
							<input type="url" class="form-control" id="photo"
								placeholder="<%= request.getParameter("profilePicture") %>"
								name="profilePicture">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="input-group mb-2">
							<input type="text" class="form-control" id="prenom"
								placeholder="<%= request.getParameter("firstName") %>"
								name="firstName">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="input-group mb-2">
							<input type="text" class="form-control" id="nom"
								placeholder="<%= request.getParameter("lastName") %>"
								name="lastName">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="input-group mb-2">
							<input type="text" class="form-control" id="phoneNumber"
								name="phoneNumber" placeholder="<%= request.getParameter("phoneNumber") %>">
						</div>
					</div>
					
					<div class="row justify-content-center">
						<button type="submit" class="btn btn-connexion">Modifier utilisateur</button>
					</div>
			</form>
